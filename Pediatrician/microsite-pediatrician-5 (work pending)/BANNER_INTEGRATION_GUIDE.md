...
|---|---|
| [`styles/banner-module.css`](file:///f:/microsites/Pediatrician/microsite-pediatrician-5/styles/banner-module.css) | Component responsive layout stylesheet. |
| [`script/banner-module.js`](file:///f:/microsites/Pediatrician/microsite-pediatrician-5/script/banner-module.js) | Light JS controller & API module with schedule controls (`window.DigiDrBanner`). |
| [`index.html`](file:///f:/microsites/Pediatrician/microsite-pediatrician-5/index.html) | Contains the HTML container `#digidrBannerModule` inside `.peds5-hero`. |
...
* **Desktop View**: The layout allows the image to scale naturally to full width (`width: 100%`) with a **16:2.5** aspect ratio.
