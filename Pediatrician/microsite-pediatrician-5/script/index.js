...
/* ==========================================================================
   Animated Stat Counters (AGENTS.md §4 — mandatory)
   IntersectionObserver threshold 0.4, ~1400ms cubic ease-out, triggers once,
   respects prefers-reduced-motion (jumps straight to final value), preserves
   +/%/k suffixes via data-suffix.
   ========================================================================== */
(function () {
...
(function () {
  ...
  function findSocialContainer(footer) {
    return (
      footer.querySelector(".peds5-footer-social") ||
