...
|---|---|
| `styles/banner-module.css` | Component responsive layout stylesheet. |
| `script/banner-module.js` | Light JS controller & API module with schedule controls (`window.DigiDrBanner`). |
| `index.html` | Contains the HTML container `#digidrBannerModule` inside `.hero-section`. |
