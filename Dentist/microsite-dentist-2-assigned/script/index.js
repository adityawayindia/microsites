...
(function () {
  ...
  function renderVisitorCounter() {
    ...
    if (existingBadge) {
      var countEl = existingBadge.querySelector(".footer-visitor-badge-count");
      if (countEl) countEl.textContent = count.toLocaleString("en-US");
      existingBadge.setAttribute(
        "aria-label",
    ...
    var countElNew = document.createElement("span");
    countElNew.className = "footer-visitor-badge-count";
    countElNew.textContent = count.toLocaleString("en-US");

    badge.appendChild(icon);
    badge.appendChild(label);
    badge.appendChild(countElNew);
